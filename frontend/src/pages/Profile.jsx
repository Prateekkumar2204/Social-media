    ...
    <div className="container container-profile w-full">
      <div className="inner-profile">
        <div className="leftprofile" style={{ backgroundColor: '#E6DFF0' }}>
          <h2 className="font-weight-bold profiletext mb-3 profiletext2" style={{ backgroundColor: '#735DA5', color: '#EDE7F6' }}>
            Profile
          </h2>
        ...
        <div className="centerprofile" style={{ backgroundColor: '#E6DFF0' }}>
          <h2 className="text-center2" style={{ backgroundColor: '#735DA5', color: '#EDE7F6' }}>
            Information
          </h2>
          ...
          <div className="profile-content">
            ...
            <div className="profile-friend">
              ...
              <h6 className="text-muted mt-2 content-text2">
          ...
          <div className="mt-3 profile-lower">
            ...
            <div className="d-flex profile-lower-inner2">
              <button
                className="btn btn-dark ml-2 upload-btn"
        ...
        <div className="bottomprofile" style={{ backgroundColor: '#E6DFF0' }}>
          <h2 className="text-white text-center2" style={{ backgroundColor: '#735DA5', color: '#EDE7F6' }}>
            Friends
          </h2>
